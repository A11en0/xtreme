...
from my_panx_model import CustomXLMRoBertaForTokenClassification, CustomXLMRobertaConfig, PseudoXLMRobertaConfig, \
    PseudoXLMRobertaForTokenClassification
...
def main():
    ...
    tokenizer = tokenizer_class.from_pretrained(args.tokenizer_name if args.tokenizer_name else args.model_name_or_path,
                                                ...
                                                cache_dir=args.cache_dir if args.cache_dir else None)
    config.langs = args.train_langs.split(',')
    # config.num_labels_list = [7]*len(config.langs)
